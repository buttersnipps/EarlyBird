...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        /*
        * Checks to see if user has the right sdk
        * if not it sets the permission to access the location
        * */
        ...
        if(Build.VERSION.SDK_INT < 15){
            ...
            ActivityCompat.requestPermissions(this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION},1);
                ...
                //this gives null the first time u run the app because the device had no last location
                mMap.clear();
                mMap.addMarker(new MarkerOptions().position(myLocation).title("My Marker"));
